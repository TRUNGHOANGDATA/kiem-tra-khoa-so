...
; Kết quả: build/Output/KiemTraKhoaSo-Setup-<VERSION>.exe

#define TenApp "Kiểm tra khóa sổ cuối kỳ"
; Doc tu file VERSION o goc repo — MOT nguon duy nhat, dung chung voi giao dien
; (ui/vite.config.ts). Truoc day so nay hard-code rieng o hai noi nen troi khoi nhau.
#define PhienBan Trim(FileRead(FileOpen("..\VERSION")))
